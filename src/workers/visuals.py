...
STYLE_PREFIX = (
    ...
    "warm amber and deep navy palette, soft gradients, vertical composition, "
)
NEGATIVE = "photo, photorealistic, 3d render, text, watermark, signature, blurry, low quality, deformed"
...
def _workflow(visual_prompt: str, seed: int) -> dict:
    return {
        ...
        "pos": {"class_type": "CLIPTextEncode",
                "inputs": {"text": STYLE_PREFIX + visual_prompt, "clip": ["ckpt", 1]}},
        ...
        "sampler": {"class_type": "KSampler", "inputs": {
            ...
            "latent_image": ["latent", 0], "seed": seed, "steps": 20, "cfg": 7.0,
